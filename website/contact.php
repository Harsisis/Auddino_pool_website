        ...
        <div class="box">
            <div class="content">
                <form name="envoi" method="post" enctype="text/plain">
                    ...
                    <input type="text" name="nom" id="nom" maxlength="100" required placeholder="Nom" autofocus="autofocus">
                    <br><br>
                    ...
                    <div style="text-align: center">
                        <input type="submit" value="Envoyer !" name="envoyer" onclick="envoi()">
                    </div>
...
<footer id="footer">
    <div class="div-row-footer">
        <div class="div-col-footer">
            <ul>
                ...
                <li class="li-footer">03 87 51 96 33</li>
                <li class="li-footer"><a href="index_contact_BLUEWAY.html">bluewaymv@outlook.com</a></li>
                <li class="li-footer">
                    <table>
                        <tr>
    ...
    <ul class="icons">
        <li><a href="https://fr-fr.facebook.com/pg/BlueWayPiscines/posts/" target="_blank" class="icon fa-facebook"><span class="label">Facebook</span></a></li>
        <li><a href="https://www.instagram.com/blueway_piscine/" target="_blank" class="icon fa-instagram"><span class="label">Instagram</span></a></li>
    </ul>
